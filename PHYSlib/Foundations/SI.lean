...
abbrev angle_unit : Dimensions := ⟨0, 0, 0, 0, 0, 0, 0⟩
abbrev PhysAngle := Scalar angle_unit
abbrev radian : PhysAngle := StandardUnit _
...
noncomputable abbrev G : Scalar (3 • length_unit - mass_unit - 2 • time_unit) := (6.67430 * (10:ℝ)^(-11:ℤ)) • StandardUnit _ -- Newton's gravitational constant
